...
Podemos apreciar que en el primer caso hay una mayor tendencia a estar en el estado de caracter gris porque este tiene una tasa de diverisficación mayor que el negro (simulado con un modelo BiSSE). En el segundo caso no hay una tendencia tan clara (simulado con un modelo independiente).
